...
SUBSCRIPTION_ID="${SUBSCRIPTION_ID:-1011dd77-657c-4c57-931b-0b77b92e7378}"
RESOURCE_GROUP="${RESOURCE_GROUP:-rg-gi-vyos-government}"
LOCATION="${LOCATION:-eastus2}"
VNET_NAME="${VNET_NAME:-vnet-gi-government}"
SUBNET_NAME="${SUBNET_NAME:-WorkloadSubnet}"
VM_NAME="${VM_NAME:-vm-government-test}"
VM_SIZE="${VM_SIZE:-Standard_D2s_v3}"
DEPLOY_PUBLIC_IP="${DEPLOY_PUBLIC_IP:-false}"
SSH_KEY_FILE="${SSH_KEY_FILE:-$HOME/.ssh/id_ed25519.pub}"
DEPLOYMENT_NAME="${DEPLOYMENT_NAME:-government-testvm-$(date +%Y%m%d%H%M%S)}"
